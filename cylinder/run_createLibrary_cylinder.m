...
modelParameters.objectFunction = @cylinderModel;
modelParameters.objectOrientations = [0 0 1]; %generateRotations(1);
modelParameters.modelSize = []; % voxels, scanner AP RL FH, keep empty to use scan size times modelMultiplier
modelParameters.modelMultiplier = 2;
...
% Read echo number 1 with specified protocol name and complex image types
...
imageParameters.readoutBandwidth = -imageParameters.readoutBandwidth; % Reverse readout polarity
